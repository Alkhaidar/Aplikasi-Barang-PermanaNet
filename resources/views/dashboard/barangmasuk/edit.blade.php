        ...
        <div class="card-body">
            <form action="{{ route('barangmasuk.update', $barangmasuks->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="">
                        <select class="form-select" name="id_barang" id="id_barang">
                            @foreach ($barangs as $barang)
                              @if (old('id_barang', $barangmasuks->id_barang) == $barang->id)
                ...
                <div class="mb-3 row">
                    ...
                    <div class="">
                        <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date" value="{{ old('date', $barangmasuks->date) }}">
                        @error('name')
                ...
                <div class="mb-3 row">
                    ...
                    <div class="">
                        <input type="number" class="form-control @error('name') is-invalid @enderror" id="stok" name="stok" value="{{ old('stok', $barangmasuks->stok) }}">
                        @error('name')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
