                ...
                <table id="myTable" class="table responsive nowrap table-bordered table-striped align-middle "  style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$barang->stok}}</td>
                            <td>
                                <a href="{{ route('barang.edit', $barang->id) }}" class="btn btn-sm btn-warning"><i class="fa-regular fa-pen-to-square"></i></a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('barang.destroy', $barang->id) }}" method="post">
                                        ...
                                        <div class="modal-body">
                                            <p class="fs-6">Apakah anda yakin akan menghapus <b>{{ $barang->name }}</b> dari Barang?</p>
                                        </div>
