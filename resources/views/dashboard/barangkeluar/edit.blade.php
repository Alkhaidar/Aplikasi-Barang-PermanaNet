        ...
        <div class="card-body">
            <form action="{{ route('barangkeluar.update', $barangkeluars->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="">
                        <input type="date" class="form-control @error('tanggalkeluar') is-invalid @enderror" id="tanggalkeluar" name="tanggalkeluar" value="{{ old('tanggalkeluar', $barangkeluars->tanggalkeluar) }}">
                        @error('name')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="">
                        <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok" name="stok" value="{{ old('stok', $barangkeluars->stok) }}">
                        @error('name')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
